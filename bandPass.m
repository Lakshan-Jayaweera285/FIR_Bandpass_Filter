...
A_tilda_p = 0.05+0.01*A;  % dB max passband ripple
A_tilda_a = 40+B; %dB min stopband attenuation
wp1 = C*100+400; %rad/s lower passband edge
wp2 = C*100+700; %rad/s upper passband edge
wa1 = C*100+250; %rad/s lower stopband edge
